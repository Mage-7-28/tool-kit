...
const VideoJx = () => {
  ...
  return (
    <div style={{width: '100%', aspectRatio: '16/9'}}>
      {(api && api !== '#') && <iframe key={videoPlayerKey} src={api.trim().toString() + playerUrl.trim().toString()} frameBorder="0" allowFullScreen width="100%" height="100%"/>}
      <div style={{margin: 5, backgroundColor: 'rgba(41,43,45,0.5)', borderRadius: 8, marginTop: 5, border: '1px solid rgba(255,255,255,0.1)'}}>
        <Select
          key={api}
          defaultValue={api}
